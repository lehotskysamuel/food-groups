...
Patria sem aj produkty živočícha (mlieko, vajce, med). Jedlá časť `*` znamená mäso bez určenej
časti (celé kurča, mleté mäso, „bravčové mäso“ v zložení salámy).
...
| živočíchy, klady | ryby: Nelson et al. 2016 (*Fishes of the World*, 5. vyd.); cicavce, vtáky, hmyz: ustálená fylogenéza | úrovne 5–7 |
...
Scombrinae, Salmoninae, Apinae/Apini…). Ostatné sú doplnené z literatúry (Suinae/Suini,
Phasianinae/Gallini, Anatinae/Anatini, Anserinae/Anserini, Thunnini, Scombrini, Cyprinini,
Oreochromini), inak `TBD`.
...
hus *Anser anser* (hus divá), králik *Oryctolagus cuniculus* (králik divý). Domáce formy bez
poddruhu v Catalogue of Life majú na úrovni 14 `-`, plemeno je na úrovni 15 (mangalica).
...
- **Česky, lebo slovenský názov nepoznáme:** superrosidy, superasteridy, rosidy, asteridy,
  ...
  (citrónová tráva), pšenice naduřelá (*Triticum turgidum*, tvrdá pšenica).
